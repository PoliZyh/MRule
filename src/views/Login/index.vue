                    ...
                    <div class="forms-wrap">
                        ...
                        <div class="form sign-in-form">
                            ...
                            <div class="heading">
                                ...
                                <a href="#/login" class="toggle">Sign up</a>
                            </div>
                            <!-- 包含输入字段和提交按钮的容器 -->
...
const handleLogin = async () => {
    try {
        const data = await api.userLoginRequest(loginParams)
        if (data.code === 200) {
            router.push({
                name: 'Projects'
            })
...
const handleRegister = async () => {
    try {
        if (registerParams.password !== registerParams.checkPassword) {
            ElMessage.error('两次密码输入不一致')
            return
        }
        const data = await api.userRegisterRequest(registerParams)
    } catch {
